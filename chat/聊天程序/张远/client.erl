...
%%
client_main_loop() ->
        io:format("Welcome to ZY chat server ~~~~n"),
        io:format("Please choose to register or log in:~n"),
        io:format("1:register~n2:log in~n"),
...
user_register(UserName, Password) ->
    ...
    {ok, Len, Data} = tcp_protocol:client_pack(10000, [UserName, Pass_Word]),
...
login(UserName, Password) ->
	Pass_Word = crypto:md5(Password),
	{ok, Len, Data} = tcp_protocol:client_pack(11000, [UserName, Pass_Word]),
	client_send_message ! {Len, Data},
	ok.
