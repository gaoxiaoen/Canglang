...
handle_call(Request, From, State) ->
    case catch cross_dungeon_handle:handle_call(Request, From, State) of
...
handle_cast(Request, State) ->
    case catch cross_dungeon_handle:handle_cast(Request, State) of
        {noreply, NewState} ->
            {noreply, NewState};
        Reason ->
...
handle_info(Request, State) ->
    case catch cross_dungeon_handle:handle_info(Request, State) of
        {noreply, NewState} ->
            {noreply, NewState};
        Reason ->
