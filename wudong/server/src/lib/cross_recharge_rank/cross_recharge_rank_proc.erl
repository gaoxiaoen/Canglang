...
%%%-------------------------------------------------------------------
-module(cross_recharge_rank_proc).
-author("Administrator").
...
%%     erlang:send_after(1000, self(), refresh_rank),
    {ok, #st_cross_recharge_rank{}}.

handle_call(Request, From, State) ->
    case catch cross_recharge_rank_handle:handle_call(Request, From, State) of
...
handle_cast(Request, State) ->
    %%?DEBUG("hand_cast ~n"),
    case catch cross_recharge_rank_handle:handle_cast(Request, State) of
        {noreply, NewState} ->
            {noreply, NewState};
        Reason ->
...
handle_info(Request, State) ->
    case catch cross_recharge_rank_handle:handle_info(Request, State) of
        {noreply, NewState} ->
            {noreply, NewState};
        Reason ->
