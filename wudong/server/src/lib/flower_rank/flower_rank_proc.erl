...
init([]) ->
    ...
    {ok, #st_flower_rank{log_list = LogList, rank_give_list = RankGiveList, rank_get_list = RankGetList}}.


handle_call(Request, From, State) ->
    case catch flower_rank_handle:handle_call(Request, From, State) of
...
handle_cast(Request, State) ->
    %%?DEBUG("hand_cast ~n"),
    case catch flower_rank_handle:handle_cast(Request, State) of
        {noreply, NewState} ->
            {noreply, NewState};
        Reason ->
...
handle_info(Request, State) ->
    case catch flower_rank_handle:handle_info(Request, State) of
        {noreply, NewState} ->
            {noreply, NewState};
        Reason ->
