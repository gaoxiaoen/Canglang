...
%% 通讯协议编码、解码处理
%% author by 苍狼工作室
%% createtime 2017-09-12 17:10:46
%%----------------------------------------------------
-module(pt_603).
...
%% 获取鲜花榜信息 
write(60300, {P0_time, P0_my_give_num, P0_my_give_rank, P0_give_list, P0_give_reward_list, P0_my_get_num, P0_my_get_rank, P0_get_list, P0_get_reward_list, P0_give_limit, P0_get_limit}) ->
    ...
    {ok, <<(byte_size(D_a_t_a) + 7):32, 60300:16,0:8, D_a_t_a/binary>>};


%% 获取达标榜信息 
write(60301, {P0_time, P0_my_give_num, P0_give_list, P0_my_get_num, P0_get_list}) ->
    ...
    {ok, <<(byte_size(D_a_t_a) + 7):32, 60301:16,0:8, D_a_t_a/binary>>};


%% 领取达标榜奖励 
write(60302, {P0_error_code}) ->
    D_a_t_a = <<P0_error_code:8>>,
    {ok, <<(byte_size(D_a_t_a) + 7):32, 60302:16,0:8, D_a_t_a/binary>>};
